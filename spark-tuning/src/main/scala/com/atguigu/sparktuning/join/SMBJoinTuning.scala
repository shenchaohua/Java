...
object SMBJoinTuning {
  ...
  def useSMBJoin( sparkSession: SparkSession ) = {
    ...
    val coursePay = sparkSession.sql("select * from default.course_pay_cluster")
      .withColumnRenamed("discount", "pay_discount")
      .withColumnRenamed("createtime", "pay_createtime")
    val courseShoppingCart = sparkSession.sql("select * from default.course_shopping_cart_cluster2")
      .drop("coursename")
    ...
    result
      ...
      .saveAsTable("default.salecourse_detail_3")
