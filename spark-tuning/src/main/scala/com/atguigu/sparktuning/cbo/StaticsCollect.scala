...
object StaticsCollect {
  ...
  def main( args: Array[String] ): Unit = {
    ...
    AnalyzeTableAndColumn(sparkSession, "default.sale_course", "courseid,dt,dn")
    AnalyzeTableAndColumn(sparkSession, "default.course_shopping_cart", "courseid,orderid,dt,dn")
    AnalyzeTableAndColumn(sparkSession, "default.course_pay", "orderid,dt,dn")
